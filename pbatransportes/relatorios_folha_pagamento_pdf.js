// relatorios_folha_pagamento_pdf.js
...
export async function exportReportToPDF(containerId, reportTitle) {
    ...
    try {
            ...
            pdf.autoTable({
                ...
                didParseCell: function (data) {
                    ...
                    if (header && (data.section === 'body' || data.section === 'foot')) {
                        ...
                        if (header.includes('Acréscimos')) {
                            if (!isNaN(value) && value > 0) {
                                data.cell.styles.fillColor = [232, 245, 233]; // Verde claro
                                data.cell.styles.fontStyle = 'bold';
                            }
                        } else if (header.includes('Descontos')) {
                            if (!isNaN(value) && value > 0) {
        ...
        // Adiciona o total geral da folha de pagamento como texto separado, se existir
