...
const crudConfig = {
    ...
    fields: [{ name: 'name', label: 'Nome da Empresa', type: 'text', required: true }],
    table: 'terceirizados'
};

/**
 * Inicializa a interface de CRUD para Empresas Terceirizadas.
 * @param {string} key - A chave de configuração do CRUD.
 */
export const initCrudTerceirizados = async (key) => {
