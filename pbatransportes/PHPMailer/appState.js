...
export const appState = {
    ...
    sand_supply_configs: [], // NOVO: Array para armazenar configurações de fornecimento de areia
    sand_deliveries: [] // NOVO: Array para armazenar lançamentos de entrega de areia
};
