...
const crudConfig = {
    ...
    fields: [{ name: 'name', label: 'Nome da Parada', type: 'text', required: true }],
    table: 'stoppage_types'
};

/**
 * Inicializa a interface de CRUD para Tipos de Parada.
 * @param {string} key - A chave de configuração do CRUD (neste caso, 'stoppage_types').
 */
export const initCrudTiposParadas = async (key) => {
